...
### 1. Weekly Trip Distribution
* **Members:** Show consistent usage throughout the work week (Monday–Friday), peaking on Wednesdays and Thursdays, suggesting a commuting-heavy behavior.
* **Casual Riders:** Show a significant surge on weekends, peaking on Saturdays at **7.5%** of total trips.
...
* **SQL:** For data aggregation and preparing the summary tables used in these charts.
